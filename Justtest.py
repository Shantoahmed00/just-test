...
def login():
	...
	print "\033[1;91m[1]\033[1;95mLogin With Facebook"
        ...
        time.sleep(0.05)
        print "\033[1;94m[4]\033[1;95mC.E.O Faysal Billal Mir "
        time.sleep(0.05)
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		idt = raw_input("\033[1;98m[+]\033[1;94mEnter ID \033[1;91m: \033[1;98m")
		try:
	...
	p.map(main, id)
#Dev: Shanto Ahmed 
        print "\033[1;98m•-----------------\033[1;38mRongbaaz\033[1;98m-----------------•"
	...
	print "\033[1;98m«-----------------\033[1;38mTm\033[1;98m-----------------»"
	print """
 \033[1;97m
